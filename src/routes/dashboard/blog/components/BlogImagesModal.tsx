  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <Button className="btn btn-outline btn-sm"> Edit Images</Button>
      </AlertDialogTrigger>
      <AlertDialogContent className="">
        ...
        <div className="text-lg">
            ...
            <p className="text-xs font-mono text-warning">Note:Remove all the deleteed inage links from your post after deleting the images</p>
        </div>
        <AlertDialogFooter>
